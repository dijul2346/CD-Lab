...
{
      -2,     0,    -2,    -2,    -2,    -1,    -1,    21,    -2,    12,
      -2,    -1,    -1,    -1,    -1,    -2,    14,    14,    -2,    -2
};
...
{
       2,     0,     3,     3,     0,     4,     5,     5,     8,     9,
       0,     6,     6,     0,    16,    17,    18,    19,    11,    12,
      13,    14,    13,    14,     0,    15,    10,    11,    12,    13,
      14
};
...
{
       0,    -1,     3,     3,    -1,     5,     7,     7,     5,     6,
      -1,    12,    12,    -1,    11,    12,    13,    14,     6,     7,
       8,     9,     8,     9,    -1,    13,     5,     6,     7,     8,
       9
};
...
{
       0,    15,     0,     3,     5,     7,    12,    16,    16,    16,
       5,     6,     7,     8,     9,    13,    16,    16,    16,    16
};
...
yyreduce:
  ...
  switch (yyn)
    {
  case 3: /* input: input expr NEWLINE  */
#line 16 "calc.y"
                            {printf("result : %d\n",yyvsp[-1]); exit(0);}
